...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="card shadow-sm border-0 rounded-4 p-4 mt-4 mx-auto" style="max-width: 700px;">
            ...
            <form method="post" action="../../controllers/package_control/create_package.php"
                class="row g-3 needs-validation" novalidate>

                <div class="col-12">
                    <label for="packageHeader" class="form-label fw-semibold">Package Header <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control form-control-lg" id="packageHeader" name="package_header"
                        required placeholder="Enter package header">
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control" id="packageDetails" name="package_details" rows="4"
                        placeholder="Describe the package"></textarea>
                </div>

                <div class="col-md-6">
                    <label for="price" class="form-label fw-semibold">Price <span class="text-danger">*</span></label>
                    <input type="number" min="0" step="0.01" class="form-control form-control-lg" id="price"
