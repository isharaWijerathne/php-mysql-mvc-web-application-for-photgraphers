                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="../../controllers/package_control/edit_package.php" novalidate>
                            ...
                            <input type="hidden" name="package_id"
                                value="<?php echo htmlspecialchars($result_h['packageID']); ?>" />

                            <div class="mb-3">
                                <label for="package_header" class="form-label fw-semibold">Package Header <span
                                        class="text-danger">*</span></label>
                                <input type="text" id="package_header" name="package_header" class="form-control"
                                    value="<?php echo htmlspecialchars($result_h['pcakageHeader']); ?>" required>
                            </div>

                            <div class="mb-3">
                                <label for="selected_cat" class="form-label fw-semibold">Package Category <span
                                        class="text-danger">*</span></label>
                                <select id="selected_cat" name="selected_cat_" class="form-select" required>
                                    ...
                                    <?php
                                    //Use picture category active result
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" id="line_one" name="line_one" class="form-control"
                                    value="<?php echo htmlspecialchars($result_h['packageInforLineOne']); ?>">
                            </div>

                            <div class="mb-3">
                                <label for="line_two" class="form-label fw-semibold">Line Two</label>
                                <input type="text" id="line_two" name="line_two" class="form-control"
                                    value="<?php echo htmlspecialchars($result_h['packageInforLineTwo']); ?>">
                            </div>

                            <div class="mb-3">
                                <label for="line_three" class="form-label fw-semibold">Line Three</label>
                                <input type="text" id="line_three" name="line_three" class="form-control"
                                    value="<?php echo htmlspecialchars($result_h['packageInforLineThree']); ?>">
                            </div>

                            <div class="mb-3">
                                <label for="package_details" class="form-label fw-semibold">Package Details</label>
                                <textarea id="package_details" name="package_details" class="form-control"
                                    rows="4"><?php echo htmlspecialchars($result_h['packageInfor']); ?></textarea>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="number" id="price" name="price" class="form-control" min="0" step="0.01"
                                    value="<?php echo htmlspecialchars($result_h['price']); ?>" required>
                            </div>
