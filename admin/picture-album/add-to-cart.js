...
const getfilePath_edit = picLocation_edit.addEventListener(
  "change",
  function () {
...
function uploadData() {
  ...
  cart.forEach((cartItem, index) => {
    ...
    formData.append(
      `photographer_name_${index + 1}`,
      cartItem.photographer_name
    );
  ...
  $.ajax({
    ...
    success: function (data) {
     location.assign("/hnd/admin/picture-album/create-new.php");
    },
