...
createMessageBox(
  "msg_model",
  "Warning",
  "This Delete will affect your data",
  "ok_btn_model"
);
...
//delete function controllers\package_control\delete_package.php
function delete_category(categoryId) {
  $.get(
    `../../controllers/package_control/delete_package.php?id=${categoryId}`,
